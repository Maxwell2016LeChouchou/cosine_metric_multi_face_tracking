""""
Comment: Histogram of oriented gradients (HOG) Python implementation using NumPy from scratch.

HOG is an image feature descripts to describe the image based on the gradients directions and magnitudes. At the current time, this project
supports calculating the following:
...
2. Concatenating the histograms of all cells within the same block
