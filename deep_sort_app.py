...
def gather_sequence_info(sequence_dir, detection_file):
    ...
    image_filenames = {
        ...
        for f in os.listdir(image_dir)}   # Form of dict (image_filenames)
...
def run(sequence_dir, detection_file, output_file, min_confidence,
    ...
    # Run tracker.
    if display:
        visualizer = visualization.Visualization(seq_info, update_ms=15)
    else:
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "metric (object appearance).", type=float, default=1.0)
    parser.add_argument(
